<template>
  ...
  >
    ...
    > -->
    <div
      class="relative bg-white max-w-md w-full rounded-lg shadow dark:bg-gray-700"
    >
      <button
        type="button"
        ...
        <ul class="my-4 space-y-3">
          <li>
            <button
              ...
              class="w-full flex items-center py-3 px-5 text-base font-bold text-gray-900 rounded-lg bg-gray-50 hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white"
            >
              <svg
                aria-hidden="true"
                class="h-4"
          ...
          <li>
            <a
              @click="$emit('wallet-connect')"
              class="w-full flex items-center py-3 px-5 text-base font-bold text-gray-900 rounded-lg bg-gray-50 hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white cursor-pointer"
            >
              <svg
                aria-hidden="true"
                class="h-5 w-5"
